...
class PublicFileTest < Minitest::Test
  ...
  def test_serves_files_for_non_rack_application
    assert_equal "/index.html\n", Net::HTTP.get(URI("http://public.localhost:20557/index.html"))
    assert_equal "/folder/index.html\n", Net::HTTP.get(URI("http://public.localhost:20557/folder/index.html"))
  end

  def test_serves_index_html
    assert_equal "/index.html\n", Net::HTTP.get(URI("http://public.localhost:20557/"))
    assert_equal "/folder/index.html\n", Net::HTTP.get(URI("http://public.localhost:20557/folder"))
  end
